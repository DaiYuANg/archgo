...
func TestAdapterMetrics(t *testing.T) {
	...
	obs.AddCounter(context.Background(), "authx_authenticate_total", 1, observability.String("result", "ok"))
	obs.RecordHistogram(context.Background(), "authx_authenticate_duration_ms", 10, observability.String("result", "ok"))
